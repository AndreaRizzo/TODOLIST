...
public class MainActivity extends AppCompatActivity {
    ...
    private RecyclerView.LayoutManager getSavedLayoutManager() {
        SharedPreferences sharedPrefs = getSharedPreferences("com.example.andrearizzo.todolist_CONFIGURATION_MODE", Context.MODE_PRIVATE);
    ...
    protected void onDestroy() {
        super.onDestroy();
        SharedPreferences layoutPreferences = getSharedPreferences("com.example.andrearizzo.todolist_CONFIGURATION_MODE", Context.MODE_PRIVATE);
